...
class DeepLinksService {
  ...
  static String keyLogoURL =
      "https://moj.jclpclaudio.com/demo/challenge/trace_icon.png";
  ...
  static Future<String> createLink(
      {required BranchUniversalObject branchObject,
      required BranchLinkProperties branchProperties,
    ...
    if (response.success) {
      ...
      debugPrint(
          'Link_generated Error : ${response.errorCode} - ${response.errorMessage}');
      return "";
    }
  }
