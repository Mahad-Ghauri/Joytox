...
class SendNotifications {
  ...
  static String getTitle(String type, {String? name}) {
    if (type == typeChat) {
      ...
      return "push_notifications.started_new_title"
  ...
  static String getMessage(String type, {String? name, String? chat}) {
    if (type == typeChat) {
      ...
      return "push_notifications.liked_your_post"
          .tr(namedArgs: {"name": name!});
    } else if (type == typeComment) {
      return "push_notifications.commented_post".tr(namedArgs: {"name": name!});
    } else if (type == typeFollow) {
      return "push_notifications.started_follow_you"
          .tr(namedArgs: {"name": name!});
    } else if (type == typeLiveInvite) {
      ...
      return "push_notifications.liked_your_reels"
          .tr(namedArgs: {"name": name!});
    } else if (type == typeCommentReels) {
      return "push_notifications.commented_reels"
          .tr(namedArgs: {"name": name!});
    } else if (type == typeStory) {
      ...
      return "push_notifications.comment_reply_explain"
          .tr(namedArgs: {"name": name!});
    } else if (type == typeProfileVisit) {
      return "push_notifications.profile_visit_explain"
          .tr(namedArgs: {"name": name!});
    }
